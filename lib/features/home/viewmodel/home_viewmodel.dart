...
class HomeViewModel extends ChangeNotifier {
  ...
  final services = [
    ...
    ServiceItem(
      ...
      bgSvgAsset: "assets/svg/bg_glucose.svg",
      route: "/glucose",
      isPrimary: false,
      bgScale: 0.70,
      bgAlignment: Alignment.centerRight,
    ...
    ServiceItem(
      ...
      bgSvgAsset: "assets/svg/bg_medication.svg",
      route: "/medication",
      isPrimary: false,
      bgScale: 0.70,
      bgAlignment: Alignment.centerRight,
    ...
    ServiceItem(
      ...
      bgSvgAsset: "assets/svg/bg_selfcare.svg",
      route: "/selfcare",
      isPrimary: false,
      bgScale: 0.70,
      bgAlignment: Alignment.centerRight,
    ...
    ServiceItem(
      ...
      bgSvgAsset: "assets/svg/bg_appointments.svg",
      route: "/appointments",
      isPrimary: false,
      bgScale: 0.70,
      bgAlignment: Alignment.centerRight,
    ...
    ServiceItem(
      ...
      bgSvgAsset: "assets/svg/bg_wellbeing.svg",
      route: "/wellbeing",
      isPrimary: false,
      bgScale: 0.70,
      bgAlignment: Alignment.centerRight,
    ...
    ServiceItem(
      ...
      bgSvgAsset: "assets/svg/bg_education.svg",
      route: "/education",
      isPrimary: false,
      bgScale: 0.70,
      bgAlignment: Alignment.centerRight,
