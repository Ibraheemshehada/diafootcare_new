                ...
                if (vm.qolEntries.isNotEmpty) ...[
                  Text('wellbeing_history'.tr(),
                      style: t.textTheme.titleMedium
                          ?.copyWith(fontWeight: FontWeight.w700)),
                  SizedBox(height: 8.h),
                  ...vm.qolEntries.map((e) => _QolHistoryTile(
                        key: ValueKey(e.id),
                        entry: e,
                        locale: locale,
    ...
    return Container(
      ...
      child: latest == null
          ? Column(
              ...
              children: [
                Text('wellbeing_latest'.tr(),
                    style: TextStyle(
                        fontSize: 13.sp, fontWeight: FontWeight.w700)),
                SizedBox(height: 6.h),
                Text('wellbeing_empty'.tr(),
          ...
          : Column(
              ...
              children: [
                ...
                _MetricRow(
                    label: 'qol_pain'.tr(), value: latest!.pain),
                SizedBox(height: 8.h),
                _MetricRow(
                    label: 'qol_mobility'.tr(), value: latest!.mobility),
                SizedBox(height: 8.h),
                _MetricRow(
                    label: 'qol_emotional'.tr(), value: latest!.emotional),
              ],
            ),
    );
  }
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 8.w),
            _MiniScore(
                label: 'qol_emotional_short'.tr(), value: entry.emotional),
          ],
        ),
      ),
    );
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 8.w),
              Expanded(
                child: Text('satisfaction_title'.tr(),
                    style: TextStyle(
